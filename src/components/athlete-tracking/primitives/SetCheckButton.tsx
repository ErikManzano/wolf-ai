...
export const SetCheckButton: React.FC<SetCheckButtonProps> = ({ status, pressed, label, onClick }) => (
  <button
    type="button"
    ...
    className={cn(
      ...
      'rounded-full touch-manipulation transition-all duration-200 active:scale-95',
